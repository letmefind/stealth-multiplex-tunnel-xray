...
5. **تنظیمات اختیاری**: برخی تنظیمات (مثل `nf_conntrack`) نیاز به ماژول‌های kernel دارند که ممکن است در همه سیستم‌ها موجود نباشند
6. **خطاهای sysctl**: اگر پیام خطای "cannot stat" برای برخی تنظیمات می‌بینید، این طبیعی است و به معنای عدم وجود آن تنظیم در سیستم شماست
7. **tcp_tw_recycle**: این تنظیم در kernel 4.12+ حذف شده و در اسکریپت استفاده نمی‌شود
